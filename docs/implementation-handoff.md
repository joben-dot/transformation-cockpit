...
This repository contains an organization-neutral demonstration with synthetic records. External source documents and organization-specific assessments are not part of the distributable project. The introduction describes only how to use the prototype.
