...
export const journeyGuidance: Record<FlowStepKey, {action:string; role:string; result:string}> = {
  ...
  measurement: {action:"Bekräfta att verksamhetsförändringen används. Rapportera vid beslutade mättidpunkter och låt mätningen verifieras. Dokumentera sedan lärandet inför avslut och eventuell skalning.",role:"Förändringsansvarig genomför, mätningsansvarig rapporterar och specialist verifierar; effektägaren följer resultatet",result:"Verifierad effekt jämförd med beslutade mål, baseline och tidsfönster."},
};
