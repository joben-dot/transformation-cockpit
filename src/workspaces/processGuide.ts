...
export const processGuide: GuideStage[] = [
  ...
  {id:"conditions",number:5,title:"Förutsättningar och körordning",short:"Visa vad som måste finnas först",purpose:"Klä det övergripande initiativet med nödvändiga förutsättningar, delinitiativ, kostnader och kapacitet. Kända beroenden beskrivs redan under beredningen och fördjupas här.",roles:"Beredningsansvarig, verksamhet, IT och arkitektur, ekonomi samt ansvariga för beroende leveranser och förvaltning.",ready:"Det framgår vad som måste vara klart före start respektive senare milstolpar, vem som levererar och när. Startblockerande förutsättningar måste vara uppfyllda före start.",location:"Ärendets steg Förutsättningar och kostnad",flowSteps:["conditions"],documents:[
