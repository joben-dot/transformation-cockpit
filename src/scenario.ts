export const municipalities = ['Kommun A', 'Kommun B', 'Kommun C', 'Kommun D', 'Kommun E'] as const
...
export const initiativeEconomics: Record<Municipality, { benefitHours: number; organizationCostKsek: number; capacity: number }> = {
  'Kommun A': { benefitHours: 1800, organizationCostKsek: 180, capacity: 0.45 },
  'Kommun B': { benefitHours: 2100, organizationCostKsek: 220, capacity: 0.5 },
  'Kommun C': { benefitHours: 1600, organizationCostKsek: 170, capacity: 0.4 },
  'Kommun D': { benefitHours: 1100, organizationCostKsek: 130, capacity: 0.3 },
  'Kommun E': { benefitHours: 1800, organizationCostKsek: 200, capacity: 0.45 },
}
