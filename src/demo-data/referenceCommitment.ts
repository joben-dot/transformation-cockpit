...
export const referenceCommitment: Extract<TransformationCommand,{commandType:"SAVE_EFFECT_COMMITMENT"}>["payload"]={
  ...
  dataSource:"ekonomirapport: årlig kostnad för ej nyttjade avtal. Samma urval används vid varje mätning.",measurementResponsibleId:roleAssignments[0].id,
  details:{category:"MONEY",annualFinancialEffect:[{year:2027,amount:150000}],metricName:"Kostnad för ej nyttjade avtal",scope:"avtal inom verksamhet Inlopp, samma avtalsurval under mätperioden.",changeDescription:"Inför månatlig avtalsgenomgång och aktiv uppsägning av avtal som inte används.",changeResponsibleId:roleAssignments[0].id,changeDueDate:"2026-12-31",receiverCapacity:"Verksamheten avsätter en avtalsansvarig 4 timmar per månad samt 2 utbildningstillfällen.",measurementDates:["2027-06-30","2027-12-31"],fullEffectDate:"2027-12-31",effectWindow:{from:"2027-01-01",to:"2027-12-31"},ownerRoleAssignmentId:createId("RoleAssignment","effect-owner-0"),baselineReference:"baselineunderlag: avtalsinventering juni 2026.",qualitySafeguard:"Andel kritiska tjänster med giltigt avtal",qualityLimit:"100 procent; inga kritiska tjänster får sakna avtal."}
};
